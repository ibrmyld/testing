...
const BlogPost = () => {
  ...
  const { trackBlogPost, trackShare, trackComment } = useAnalytics();
  ...
  useEffect(() => {
    ...
    if (foundPost) {
      ...
      trackBlogPost(foundPost.id, foundPost.title, foundPost.category);
    }
  }, [slug, trackBlogPost]);
  ...
  const handleAddComment = (newComment) => {
    ...
    trackComment(post.id, 'add_comment');
  };
    ...
    <div className="min-h-screen py-8">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="p-8 border-b border-gray-200 dark:border-dark-700">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <SocialShare 
                ...
                title={post.title}
                description={post.excerpt}                onShare={handleShare}              />
            </div>
          ...
          {/* Article Content */}
          <div className="p-8">
          <div ref={contentRef} className="p-8">se prose-lg dark:prose-invert max-w-none">
              {post.content.split('\n').map((paragraph, index) => {
